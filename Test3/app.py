"""
光储充智能预测 Demo — Gradio 主应用 (Test3: LightGBM 版本)
基于真实气象 API + 历史训练数据 + 预测模型权重
充电负荷预测使用 LightGBM 替代 TCN-Attention-LSTM
"""
import os
import sys
import gradio as gr
        ...
        gr.HTML(
            ...
            <div style="text-align:center; margin-bottom:20px;">
                ...
                <p style="font-size:14px; opacity:0.7;">
                    光伏预测 (LSTM + 对抗训练) | 充电负荷预测 (LightGBM) | 历史数据探索
                </p>
            </div>
            """
        )
