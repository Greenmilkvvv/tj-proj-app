"""
光储充预测 Demo — 全局配置文件 (Test3: LightGBM 版本)
...
CHARGING_MODEL_PTH = os.path.join(BASE_DIR, "lightgbm_charging_model.pkl")  # LightGBM 模型
...
# UI 配置
# ============================================================
APP_TITLE = "光储充智能预测 Demo (LightGBM)"
APP_PORT = 7861  # 不同端口避免与 Test2 冲突
APP_THEME = "soft"